...
const MyWork = () => {
    return (
        <div id="realisations" className="w-full bg-redprimary text-white overflow-hidden">
            <div className="container pt-56 pb-64 5xl:px-48 5xl:pb-96 7xl:pb-[700px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 mt-56 gap-8 xl:gap-0">
                    <div className="flex flex-col z-10 items-center justify-center col-span-1 lg:col-span-7 mb-20 lg:mb-0 relative">
                        ...
                        <Image src="/images/project_sample_img_2.png" className="w-13/24 7xl:w-10/24 7xl:left-1 -left-4 xsmall:-left-5 xs:-left-6 md:left-0 h-auto object-cover absolute -bottom-4/24 self-start" alt="sample img from projects" width={650} height={550} />
                    </div>
                    <div className="flex flex-col mt-8 lg:mt-0 z-0 col-span-1 lg:col-span-5 relative">
                        <BlobCircle gradientId="grad3" className="absolute -bottom-3/24 sm:bottom-0 lg:-bottom-3/24 -right-20/24 lg:-right-3/5 2-5xl:-right-2/5 2xl:-right-15/24 2xl:-bottom-9/24 4xl:-right-11/24 5xl:-bottom-13/24 5xl:-right-14/24 7xl:-right-10/24 7xl:-bottom-22/24 -z-10 w-750 h-750 lg:w-750 lg:h-750 xl:w-950 xl:h-950 2xl:w-1200 2xl:h-1200 3xl:w-1300 3xl:h-1300 5xl:w-[1400px] 5xl:h-[1400px] 7xl:w-[1800px] 7xl:h-[1800px]" />
                        <BlobCircle gradientId="grad4" className="absolute -bottom-1/4  -right-4/12 hidden lg:block lg:-bottom-13/24 lg:-right-6/12 xl:-right-4/12 xl:-bottom-9/24 3xl:-right-4/12 5xl:-bottom-13/24 5xl:-right-14/24 7xl:-right-9/24 7xl:-bottom-17/24 3xl:w-411 3xl:h-411 5xl:w-[511px] 5xl:h-[511px] -z-10 w-96 h-96" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 mt-32 lg:mt-72 2xl:mt-96 gap-8 xl:gap-0 ">
                    <div className="flex flex-col z-10 lg:order-2 items-center justify-center col-span-1 lg:col-span-7 mb-20 lg:mb-0 relative">
                        ...
                        <Image src="/images/ecarmotors-sample_img_1.png" className="w-13/24 7xl:w-10/24 7xl:left-16 -left-4 xsmall:-left-5 xs:-left-6 md:left-0 h-auto object-cover absolute -bottom-4/24 self-start" alt="sample img from projects" width={650} height={550} />
                    </div>
                    <div className="flex flex-col mt-8 lg:order-1 md:mt-0 z-0 col-span-1 lg:col-span-5 relative">
                        <BlobCircle gradientId="grad3" className="absolute -bottom-3/24 sm:bottom-0 lg:-bottom-3/24 -left-20/24 lg:-left-3/5 2xl:-left-15/24 2-5xl:-left-2/5 2xl:-bottom-9/24 4xl:-left-11/24 5xl:-bottom-13/24 5xl:-left-14/24 7xl:-left-10/24 7xl:-bottom-22/24 -z-10 w-750 h-750 xl:w-950 xl:h-950 2xl:w-1200 2xl:h-1200 3xl:w-1300 3xl:h-1300 5xl:w-[1400px] 5xl:h-[1400px] 7xl:w-[1800px] 7xl:h-[1800px] rotate-180" />
                        <BlobCircle gradientId="grad4" className="absolute -bottom-1/4  -left-4/12 hidden lg:block lg:-bottom-13/24 lg:-left-6/12 xl:-left-4/12 xl:-bottom-9/24 -z-10 w-96 h-96 3xl:-left-4/12 5xl:-left-14/24 5xl:-bottom-13/24 7xl:-left-9/24 7xl:-bottom-17/24 3xl:w-411 3xl:h-411 5xl:w-[511px] 5xl:h-[511px] rotate-180" />
