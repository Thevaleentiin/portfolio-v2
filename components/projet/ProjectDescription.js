...
const ProjectDescription = ({role, contexte, annee, stackLogo, stackLogo2, stackLogo3, description, imgNames }) => {
    ...
    return (
        <div className="bg-redprimary dark:bg-[#4A1714] text-whiteprimary pb-60">
            <div className="container relative">
                ...
                <motion.div ref={ref} initial={{opacity: 0, y: -100}} animate={isInView ? { opacity: 1, y: 0} : {}} transition={{ duration: 1, delay: 0.3 }} className="w-20/24 xxs:w-18/24 sm:w-3/5 mx-auto pt-44">
                    ...
                    <ul className="flex flex-row items-center gap-4 justify-start mt-3">
                        <li><Image src={stackLogo} alt={imgNames[0]} width={55} height={31} sizes="55px" quality={75} /></li>
                        <li><Image src={stackLogo2} alt={imgNames[1]} width={55} height={31} sizes="55px" quality={75} /></li>
                        <li><Image src={stackLogo3} alt={imgNames[2]} width={55} height={31} sizes="55px" quality={75} /></li>
                    </ul>
                </motion.div>
            </div>
        </div>
